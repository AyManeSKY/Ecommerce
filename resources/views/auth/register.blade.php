                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="numero_telephone" type="text" class="form-control @error('numero_telephone') is-invalid @enderror" name="numero_telephone" value="{{ old('numero_telephone') }}" required autocomplete="numero_telephone" autofocus>
