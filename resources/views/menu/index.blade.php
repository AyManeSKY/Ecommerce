@include('layaouts')
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(images/bg_1.jpg);">
      ...
      <div class="slider-item" style="background-image: url(images/bg_3.jpg);">
				...
				@foreach($pizzas->take(6) as $pizza)
					<div class="col-lg-4 d-flex ftco-animate">
						<div class="services-wrap d-flex">
							<a href="#" class="img" style="background-image: url({{'storage/' . $pizza->image ?? 'images/default.jpg' }});"></a>
							<div class="text p-4">
								<h3>{{ $pizza->nom }}</h3>
								<p>{{ $pizza->description }}</p>
								<p class="price"><span>${{ $pizza->prix }}</span></p>
        ...
        <div class="row">
			<div class="col-md-6">
				@foreach($pizzas->slice(0, 4) as $pizza)
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url({{'storage/' . $pizza->image ?? 'images/default.jpg' }});"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
								<h3><span>{{ $pizza->nom }}</span></h3>
								<span class="price">${{ $pizza->prix }}</span>
							</div>
							<div class="d-block">
								<p>{{ $pizza->description }}</p>
							</div>
			...
			<div class="col-md-6">
				@foreach($pizzas->slice(4, 4) as $pizza)
					<div class="pricing-entry d-flex ftco-animate">
						<div class="img" style="background-image: url({{ 'storage/' .$pizza->image ?? 'images/default.jpg' }});"></div>
						<div class="desc pl-3">
							<div class="d-flex text align-items-center">
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
						...
						<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
							<div class="row">
								@foreach($pizzas->slice(0, 3) as $pizza)
									<div class="col-md-4 text-center">
										<div class="menu-wrap">
											<a href="#" class="menu-img img mb-4" style="background-image: url({{ 'storage/' .$pizza->image ?? 'images/default.jpg' }});"></a>
											<div class="text">
												<h3><a href="#">{{ $pizza->nom }}</a></h3>
												<p>{{ $pizza->description }}</p>
												<p class="price"><span>${{ $pizza->prix }}</span></p>
												<p><a href="{{ route('addpizza.to.cart', $pizza->id) }}" class="btn btn-white btn-outline-white">Add to cart</a></p>
											</div>
										</div>
									</div>
								@endforeach
